...
{% endif %}
<form class="ui form" method="post" action="{{ url('content/table/add') }}">
    <div class="fields">
        <div class="three wide field">
            <label>Table Number (Code)</label>
            <input type="text" name="number" placeholder="Table Number (Code)" value="{% if request.isPost() %}{{ request.getPost('number') }}{% else %}{% endif %}">
        </div>
        <div class="two wide field">
            <label>Floor</label>
            <div class="ui selection fluid dropdown">
                <input type="hidden" name="floor" placeholder="Floor Level" value="{% if request.isPost() %}{{ request.getPost('floor') }}{% else %}{% endif %}">
    ...
    <div class="field">
        ...
        <textarea name="description" placeholder="Table Description">{% if request.isPost() %}{{ request.getPost('description') }}{% else %}{% endif %}</textarea>
    </div>
    <div class="fields">
        <div class="two wide field">
            <label>Position</label>
            <input type="text" name="x" placeholder="Position X" value="{% if request.isPost() %}{{ request.getPost('x') }}{% else %}{% endif %}">
        </div>
        <div class="two wide field">
            <label>&nbsp;</label>
            <input type="text" name="y" placeholder="Position Y" value="{% if request.isPost() %}{{ request.getPost('y') }}{% else %}{% endif %}">
        </div>
        <div class="two wide field">
            <label>Available</label>
            <div class="ui selection fluid dropdown">
                <input type="hidden" name="available" placeholder="Available" value="{% if request.isPost() %}{{ request.getPost('available') }}{% else %}true{% endif %}">
                <i class="dropdown icon"></i>
