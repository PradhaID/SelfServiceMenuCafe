...
<form class="ui form" method="post" action="{{ url('system/user/add/') }}">
    <div class="fields">
        <div class="five wide field">
            <label>Group</label>
            <div class="ui selection dropdown">
                <input type="hidden" name="group" value="{% if request.isPost() %}{{ request.get('group') }}{% else %}{% endif %}">
        ...
        <div class="three wide field">
            ...
            <input type="text" name="username" placeholder="Username" value="{% if request.isPost() %}{{ request.get('username') }}{% else %}{% endif %}">
        </div>
        <div class="eight wide field">
            <label>Full Name</label>
            <input type="text" name="name" placeholder="Full Name" value="{% if request.isPost() %}{{ request.get('name') }}{% else %}{% endif %}">
        </div>
    </div>
    <div class="field">
        <label>Biography</label>
        <textarea name="biography" placeholder="Biography">{% if request.isPost() %}{{ request.get('biography') }}{% else %}{% endif %}</textarea>
    </div>
    <div class="fields">
        <div class="five wide field">
            <label>E-Mail</label>
            <input type="text" name="email" placeholder="E-Mail" value="{% if request.isPost() %}{{ request.get('email') }}{% else %}{% endif %}">
        </div>
        <div class="three wide field">
            <label>Phone</label>
            <input type="text" name="phone" placeholder="Phone" value="{% if request.isPost() %}{{ request.get('phone') }}{% else %}{% endif %}">
        </div>
        <div class="three wide field">
            <label>Gender</label>
            <div class="ui selection dropdown" value="{% if request.isPost() %}{{ request.get('gender') }}{% else %}{% endif %}">
