...
{% endif %}
<form class="ui form" method="post" action="{{ url('system/group/edit/') }}{{ id }}">
    <div class="fields">
        <div class="eight wide field">
            <label>Group Name</label>
            <input type="text" placeholder="Group Name" name="name" value="{% if request.isPost() %}{{ request.get('name') }}{% else %}{{ group.name }}{% endif %}">
        </div>
    </div>
    <div class="field">
        <label>Group Description</label>
        <textarea name="description" placeholder="Group Description">{% if request.isPost() %}{{ request.get('description') }}{% else %}{{ group.description }}{% endif %}</textarea>
    </div>
    <div class="field">
